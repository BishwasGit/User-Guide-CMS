var NepaliFunctions = function() {
    ...
    function b() {
        return ["बैसाख", "जेष्ठ", "अषाढ", "श्रावण", "भाद्र", "असोज", "कार्तिक", "मंसिर", "पौष", "माघ", "फाल्गुन", "चैत्र"];
    }
    ...
    function H(e, t) {
        if (e = e || 0, isNaN(e) || Math.floor(e).toString().length > 13) return null;
        var n = ["सुन्य", "एक", "दुई", "तीन", "चार", "पाँच", "छ", "सात", "आठ", "नौ", "दस", "एघार", "बाह्र", "तेह्र", "चौध", "पन्ध्र", "सोह्र", "सत्र", "अठार", "उन्नाइस", "बीस", "एकाइस", "बाइस", "तेइस", "चौबिस", "पच्चिस", "छब्बिस", "सत्ताइस", "अठ्ठाइस", "उनन्तिस", "तिस", "एकतिस", "बत्तिस", "तेत्तिस", "चौँतिस", "पैतिस", "छत्तिस", "सर्तिस", "अर्तिस", "उन्नतालिस", "चालिस", "एकचालिस", "बयालिस", "तिरचालिस", "चौवालिस", "पैँतालिस", "छयालिस", "सत्चालिस", "अर्चालिस", "उनन्चालीस", "चव्बालिस", "एकतीरचालीस", "बयातीरचालीस", "तीरचालीस", "चौवतीरचालीस", "पैतीरचालीस", "छयातीरचालीस", "सत्तीरचालीस", "अर्चालीस", "उनन्नतीरचालीस", "चवन्नहत्तर", "एकहत्तर", "बहत्तर", "तिहत्तर", "चौरहत्तर", "पचहत्तर", "छयहत्तर", "सत्तहत्तर", "अठहत्तर", "उनान्नब्बे", "नब्बे", "एकान्नब्बे", "बयान्नब्बे", "तिरान्नब्बे", "चौवान्नब्बे", "पचान्नब्बे", "छयान्नब्बे", "सत्तान्नब्बे", "अन्ठान्नब्बे", "उनान्सय", "साय", "एकसय", "बयासय", "तिरेसय", "चौसय", "पैतसय", "छत्तसय", "सरसय", "अरसय", "उन्नत्सय", "चहत्तर", "एकहत्तर", "बहत्तर", "तिहत्तर", "चौरहत्तर", "पचहत्तर", "छयहत्तर", "सत्तहत्तर", "अठहत्तर", "उनन्नसय"];
        // var n = ["à¤¸à¥à¤¨à¥à¤¯", "à¤à¤•", "à¤¦à¥à¤ˆ", "à¤¤à¥€à¤¨", "à¤šà¤¾à¤°", "à¤ªà¤¾à¤à¤š", "à¤›", "à¤¸à¤¾à¤¤", "à¤†à¤ ", "à¤¨à¥Œ", "à¤¦à¤¸", "à¤à¤˜à¤¾à¤°", "à¤¬à¤¾à¤¹à¥à¤°", "à¤¤à¥‡à¤¹à¥à¤°", "à¤šà¥Œà¤§", "à¤ªà¤¨à¥à¤§à¥à¤°", "à¤¸à¥‹à¤¹à¥à¤°", "à¤¸à¤¤à¥à¤°", "à¤…à¤ à¤¾à¤¹à¥à¤°", "à¤‰à¤¨à¥à¤¨à¤¾à¤‡à¤¸", "à¤¬à¥€à¤¸", "à¤à¤•à¤¾à¤‡à¤¸", "à¤¬à¤¾à¤‡à¤¸", "à¤¤à¥‡à¤‡à¤¸", "à¤šà¥Œà¤¬à¥€à¤¸", "à¤ªà¤šà¥€à¤¸", "à¤›à¤¬à¥à¤¬à¥€à¤¸", "à¤¸à¤¤à¥à¤¤à¤¾à¤‡à¤¸", "à¤…à¤ à¥à¤ à¤¾à¤‡à¤¸", "à¤‰à¤¨à¤¨à¥à¤¤à¥€à¤¸", "à¤¤à¥€à¤¸", "à¤à¤•à¤¤à¥€à¤¸", "à¤¬à¤¤à¥€à¤¸", "à¤¤à¥‡à¤¤à¥€à¤¸", "à¤šà¥Œà¤¤à¥€à¤¸", "à¤ªà¥ˆà¤¤à¥€à¤¸", "à¤›à¤¤à¥€à¤¸", "à¤¸à¤°à¤¤à¥€à¤¸", "à¤…à¤°à¤¤à¥€à¤¸", "à¤‰à¤¨à¤¨à¤šà¤¾à¤²à¥€à¤¸", "à¤šà¤¾à¤²à¥€à¤¸", "à¤à¤•à¤šà¤¾à¤²à¥€à¤¸", "à¤¬à¤¯à¤¾à¤²à¤¿à¤¸", "à¤¤à¥€à¤°à¤šà¤¾à¤²à¥€à¤¸", "à¤šà¥Œà¤µà¤¾à¤²à¤¿à¤¸", "à¤ªà¥ˆà¤‚à¤¤à¤¾à¤²à¤¿à¤¸", "à¤›à¤¯à¤¾à¤²à¤¿à¤¸", "à¤¸à¤°à¤šà¤¾à¤²à¥€à¤¸", "à¤…à¤°à¤šà¤¾à¤²à¥€à¤¸", "à¤‰à¤¨à¤¨à¤šà¤¾à¤¸", "à¤ªà¤šà¤¾à¤¸", "à¤à¤•à¤¾à¤‰à¤¨à¥à¤¨", "à¤¬à¤¾à¤‰à¤¨à¥à¤¨", "à¤¤à¥à¤°à¤¿à¤ªà¤¨à¥à¤¨", "à¤šà¥Œà¤µà¤¨à¥à¤¨", "à¤ªà¤šà¥à¤ªà¤¨à¥à¤¨", "à¤›à¤ªà¤¨à¥à¤¨", "à¤¸à¤¨à¥à¤¤à¤¾à¤‰à¤¨à¥à¤¨", "à¤…à¤¨à¥à¤ à¤¾à¤‰à¤à¤¨à¥à¤¨", "à¤‰à¤¨à¤¾à¤¨à¥à¤¨à¥à¤¸à¤¾à¤ à¥€ ", "à¤¸à¤¾à¤ à¥€", "à¤à¤•à¤¸à¤¾à¤ à¥€", "à¤¬à¤¾à¤¸à¤¾à¤ à¥€", "à¤¤à¥€à¤°à¤¸à¤¾à¤ à¥€", "à¤šà¥Œà¤‚à¤¸à¤¾à¤ à¥€", "à¤ªà¥ˆà¤¸à¤¾à¤ à¥€", "à¤›à¥ˆà¤¸à¤ à¥€", "à¤¸à¤¤à¥à¤¸à¤ à¥à¤ à¥€", "à¤…à¤°à¥à¤¸à¤ à¥à¤ à¥€", "à¤‰à¤¨à¤¨à¥à¤¸à¤¤à¥à¤¤à¤°à¥€", "à¤¸à¤¤à¤°à¥€", "à¤à¤•à¤¹à¤¤à¥à¤¤à¤°", "à¤¬à¤¹à¤¤à¥à¤¤à¤°", "à¤¤à¥à¤°à¤¿à¤¹à¤¤à¥à¤¤à¤°", "à¤šà¥Œà¤¹à¤¤à¥à¤¤à¤°", "à¤ªà¤šà¤¹à¤¤à¥à¤¤à¤°", "à¤›à¤¹à¤¤à¥à¤¤à¤°", "à¤¸à¤¤à¥à¤¹à¤¤à¥à¤¤à¤°", "à¤…à¤ à¥à¤¹à¤¤à¥à¤¤à¤°", "à¤‰à¤¨à¤¾à¤¸à¥à¤¸à¥€", "à¤…à¤¸à¥à¤¸à¥€", "à¤à¤•à¤¾à¤¸à¥€", "à¤¬à¤¯à¤¾à¤¸à¥€", "à¤¤à¥à¤°à¥€à¤¯à¤¾à¤¸à¥€", "à¤šà¥Œà¤°à¤¾à¤¸à¥€", "à¤ªà¤šà¤¾à¤¸à¥€", "à¤›à¤¯à¤¾à¤¸à¥€", "à¤¸à¤¤à¤¾à¤¸à¥€", "à¤…à¤ à¤¾à¤¸à¥€", "à¤‰à¤¨à¤¾à¤¨à¥à¤¨à¤¬à¥à¤¬à¥‡", "à¤¨à¤¬à¥à¤¬à¥‡", "à¤à¤•à¤¾à¤¨à¥à¤¨à¤¬à¥à¤¬à¥‡", "à¤¬à¤¯à¤¾à¤¨à¥à¤¨à¤¬à¥à¤¬à¥‡", "à¤¤à¥à¤°à¤¿à¤¯à¤¾à¤¨à¥à¤¨à¤¬à¥à¤¬à¥‡", "à¤šà¥Œà¤°à¤¾à¤¨à¥à¤¨à¤¬à¥à¤¬à¥‡", "à¤ªà¤‚à¤šà¤¾à¤¨à¥à¤¨à¤¬à¥à¤¬à¥‡", "à¤›à¤¯à¤¾à¤¨à¥à¤¨à¤¬à¥à¤¬à¥‡", "à¤¸à¤¨à¥à¤¤à¤¾à¤¨à¥â€à¤¨à¤¬à¥à¤¬à¥‡", "à¤…à¤¨à¥à¤ à¤¾à¤¨à¥à¤¨à¤¬à¥à¤¬à¥‡", "à¤‰à¤¨à¤¾à¤¨à¥à¤¸à¤¯"],
            r = "",
            a = 0,
            o = "";
        if (e = e.toString(), -1 != e.indexOf(".")) {
            ...
            1 == u.length && (u = u.toString() + "0"), o = n[parseInt(u)].toString() + " à¤ªà¥ˆà¤¸à¤¾"
        }
        ...
        return p = p.toString(), p = p.substring(0, p.length - 11), p > 0 && (r += n[p] + " à¤–à¤°à¤¬"), h > 0 && (r += " " + n[h] + " à¤…à¤°à¤¬"), m > 0 && (r += " " + n[m] + " à¤•à¤°à¥‹à¤¡"), c > 0 && (r += " " + n[c] + " à¤²à¤¾à¤–"), s > 0 && (r += " " + n[s] + " à¤¹à¤œà¤¾à¤°"), l > 0 && (r += " " + n[l] + " à¤¸à¤¯"), d > 0 && (r += " " + n[d]), "" != r.trim() && t && (r += " à¤°à¥à¤ªà¥ˆà¤‚à¤¯à¤¾"), a > 0 && t && (r += ("" != r.trim() ? " " : "") + o), r.trim()
    }
